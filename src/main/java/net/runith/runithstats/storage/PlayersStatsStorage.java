...
import net.runith.runithstats.database.repository.Repository;
...
public final class PlayersStatsStorage {
    ...
    private final Repository<PlayerStats> playerStatsRepository;
    ...
    public void loadPlayerStats(final Player player) {
        ...
        executorService.execute(() -> cachedStats.put(uuid, playerStatsRepository.findById(uuid)
            .orElse(new PlayerStats(uuid, name, System.currentTimeMillis()))));
    }
